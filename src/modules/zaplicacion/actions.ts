...
export namespace Actions {
    ...
    export const lanzarAplicacion
        = (idApl: string, nomApl: string, username: string = "", lanzarMenu: string, nombreOpcion: string, tkna: string): any =>
                    ...
                    dispatch(ZComunicaciones.Actions.enviarRequestComando<IZColaEventos>({
                        ...
                        .then(
                            (resultadoCmAplicacion: ResultadoActionConDato<IZColaEventos>) => {
                                ...
                                Services.Responder.procesarZColaEventos(resultadoCmAplicacion.retorno, dispatch, getState);
